...
def parse_args():
    descript = 'Pytorch Implementation of \'Understanding Rich Temporal Information for Point-Supervised Temporal Action Localization\''
    parser = argparse.ArgumentParser(description=descript)

    parser.add_argument('--data_path', type=str, default='./dataset/THUMOS14')
    parser.add_argument('--model_path', type=str, default='./models/ITLM')
    parser.add_argument('--output_path', type=str, default='./outputs/ITLM')
    parser.add_argument('--log_path', type=str, default='./logs/ITLM')
    ...
    parser.add_argument('--model_file', type=str, default='./models/ITLM_best.pkl', help='the path of pre-trained model file')
